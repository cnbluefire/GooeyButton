...
namespace GooeyButton
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void gooeyButton_Invoked(object sender, Controls.GooeyButton.GooeyButtonInvokedEventArgs args)
        {
            System.Diagnostics.Debug.WriteLine("Invoked");
        }

        private void gooeyButton_ItemInvoked(object sender, Controls.GooeyButton.GooeyButtonItemInvokedEventArgs args)
        {
